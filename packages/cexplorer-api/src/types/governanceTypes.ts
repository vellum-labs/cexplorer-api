...
export type GovernanceActionDetailResponse = ResponseCore<GovernanceActionDetail>;

export type GovernanceVoteDetailResponse = ResponseCore<GovernanceVoteDetailData>;
...
export interface CommitteeMember {
  ...
  registration: CommitteeMemberRegistration | CommitteeMemberRegistration[] | null;
  de_registration: CommitteeMemberRegistration | CommitteeMemberRegistration[] | null;
  expiration_epoch: number | null;
}
